import './style.css';
const PROFILE = {"day":"Day068","title":"Family Photo Caption Rail","display_name_ja":"家族写真ひと言レール","one_sentence":"家族写真に短い記録を添えて、あとで見返す列にするツール","purpose_line_ja":"家族写真ひと言レールを作るためのツールです。","use_case_line_ja":"旅行後に写真を少しだけ整理したい時に使います。","how_it_works_line_ja":"項目を入れると、結果カードが出ます。","core_action":"flow_pick","family":"photo_caption_memory_log","mechanic":"flow_pick","input_style":"photo_cards","output_style":"choice_cards","output_label":"ここを見ればOKです","audience_promise":"写真整理を重くせず、思い出の芯だけ残せる。","publish_hook":"写真名と一言を入れると、見返せる短い記録列がすぐできる。","engine":"brief_driven","interaction_archetype":"flow_pick","page_archetype":"photo_wall","ui_variant":"dinner","intro_variant":"dinner_pick","interaction_model":"toggle_ingredients_to_survivor_meals","primary_layout":"ingredient_filter_bar_with_meal_cards","result_presentation_style":"remaining_meal_cards","palette_motif":"キッチンアプリコット","main_cta":"冷蔵庫の残りで試す","input_panel_title":"今ある食材を選ぶ","sample_panel_title":"冷蔵庫の残りで試す","guide_panel_title":"献立の見どころ","hero_panel_label":"今夜の候補","output_shape":"photo_wall","state_model":"flow_pick_state","core_loop":"photo_cards -> flow_pick -> choice_cards","component_pack":"photo_wall+choice_cards","scaffold_id":"brief_canvas","single_shot_text_generator":false};
